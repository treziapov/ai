...
def train_linear_regressor_model(
    ...
    plt.tight_layout()
    plt.plot(training_rmse, label="trainig")
...
# Task 1: calculate log loss (if applicable).
# Answer: we can
predict_validation_input_fn = lambda: my_input_fn(
        validation_examples,
        validation_targets["median_house_value_is_high"],
...
# Task 2: train a logistic regression model and calculate log loss on the validation set.
...
linear_classifier = train_linear_classifier(
    ...
    training_targets=training_targets,
    validation_examples=validation_examples,
    validation_tragets=validation_targets
)
...
print('Accuracy on the validation set: %0.2f' % evaludation_metrics['accuracy'])
...
# Tuning for better results/metrics
